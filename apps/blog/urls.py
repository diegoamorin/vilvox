...
urlpatterns = [
    ...
    path(
        'post/delete/confirm/<int:pk>',
        confirmDeletePost,
        name="confirmDeletePost"
    ),
    path(
        'post/delete/cancel/<slug:slug>',
        cancelDeletePost,
        name="cancelDeletePost"
    ),
    path('serie/delete/<int:pk>/', deleteSerie, name="deleteSerie"),
    path(
        'serie/delete/confirm/<int:pk>',
        confirmDeleteSerie,
        name="confirmDeleteSerie"
    ),
    path(
        'serie/delete/cancel/<slug:slug>',
        cancelDeleteSerie,
        name="cancelDeleteSerie"
    ),
