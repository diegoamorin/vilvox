...
from .views import (
	...
	editGame, deleteGame, confirmDeleteGame, cancelDeleteGame,
)
...
urlpatterns = [
	...
	path("game/delete/confirm/<slug:slug>", confirmDeleteGame, name="confirmDeleteGame"),
	path("game/delete/cancel/<slug:slug>", cancelDeleteGame, name="cancelDeleteGame"),
